...
public class AccessOMDB
{
    ...
    {
        String imdbID;
        //System.out.println(json.getAsJsonObject().get("Response").getAsString());
        if (json.getAsJsonObject().get("Response").getAsString().equals("True"))
        {
            imdbID = json.getAsJsonObject().get("Search").getAsJsonArray().get(0).getAsJsonObject().get("imdbID").getAsString();
